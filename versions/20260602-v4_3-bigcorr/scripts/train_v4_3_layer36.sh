#!/usr/bin/env bash
# =============================================================================
# V4.3 (path B + radius8 + iters12)：单层 Layer 36，双图拼接，Q←corrected / K←warped（跨图）
#
...
train_id=20260602-v4_3-bigcorr-layer36
...
accelerate launch train_flow_head_v4_3.py \
  ...
  --output_path "/juicefs-algorithm/data/IPT/zhuochu_yang/DiffSynth-Studio/flow_head_v4_3_ckpts/$train_id" \
