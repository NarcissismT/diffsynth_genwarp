#!/usr/bin/env bash
# =============================================================================
# V4.2 SHAM 对照：单层 Layer 36，双图拼接，Q←corrected / K←corrected（同图，等价 V4.1）
#
...
train_id=20260601-v4_2-sham-layer36
...
accelerate launch train_flow_head_v4_2_pathB.py \
  ...
  --output_path "/juicefs-algorithm/data/IPT/zhuochu_yang/DiffSynth-Studio/flow_head_v4_2_ckpts/$train_id" \
