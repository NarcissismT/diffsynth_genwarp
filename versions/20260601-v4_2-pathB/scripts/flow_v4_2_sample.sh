...
OUTPUT_DIR="/juicefs-algorithm/workspace/IPT/zhuochu_yang/diffsynth_genwarp/flow_v4_2_results"

# ---- FlowHead V4.2 checkpoint（path B，单层 Layer 36）----
CKPT="/juicefs-algorithm/data/IPT/zhuochu_yang/DiffSynth-Studio/flow_head_v4_2_ckpts/20260601-v4_2-pathB-layer36/step-435060.safetensors"
DIT_LAYERS="35"
K_SOURCE="warped"        # 必须与训练一致（pathB=warped）
EXP_SUFFIX="pathB_layer36_step435k"
...
$PYTHON qwen_image_flow_v4_2.py \
    --input_dir         "$INPUT_DIR" \
