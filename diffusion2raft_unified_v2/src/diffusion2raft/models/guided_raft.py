...
class GuidedRectificationRAFT(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        # Keep pixel coordinates in FP32 under mixed precision. BF16 coordinate
        # grids become quantized above 256px and can themselves create ripples.
        ...
        residuals = [self._bound_residual(residual.float()) for residual in residual_predictions]
        with torch.autocast(device_type=warped.device.type, enabled=False):
