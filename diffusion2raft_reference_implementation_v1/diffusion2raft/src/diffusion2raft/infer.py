...
from .metrics import line_bending
    ...
    *,
    ...
    if stage == "joint":
        if guide_path is None:
            raise ValueError("joint inference needs --guide; generate and cache it with d2r-generate-guides")
    ...
    metadata = {
        ...
        "invalid_ratio": float(1.0 - valid.float().mean().cpu()),
        "fold_rate": fold_rate,
        "jacobian_p01": jacobian_p01,
        "line_bending": line_bending(flow_native, valid),
    }
