...
from diffsynth.trainers.utils_re import DiffusionTrainingModule, ImageDataset, ModelLogger, launch_training_task, qwen_image_parser
...
class QwenImageTrainingModule(DiffusionTrainingModule):
    ...
    def forward(self, data, inputs=None):
        ...
        # models: dit, blockwise_controlnet

        # noise: torch.Size([1, 16, 152, 106])
        # latents: torch.Size([1, 16, 152, 106])
        # input_latents: torch.Size([1, 16, 152, 106])
        # edit_latents: torch.Size([1, 16, 152, 106])
        # prompt_emb: torch.Size([1, 1305, 3584])
        # prompt_emb_mask: torch.Size([1, 1305])
        return loss
