...
CUDA_VISIBLE_DEVICES=5 python qwen_image_batch.py \
  --lora_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/models/train/qwen-image-edit/20250825/full/dehighlight_200/step-100.safetensors" \
