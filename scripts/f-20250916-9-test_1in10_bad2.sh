...
ckpt="/juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/result/20250915-1_1in10_unwarp/step-52000.safetensors"
...
# 运行 Python 脚本，传递 --crop 参数
 python /juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/qwen_image_batch_full_lora.py \
  --lora_path $ckpt \
  --input_dir "$test_set" \
  --output_dir "$ckpt.visualization/0916-9_bad2_0915-1-52000_trueprompt_1024_$resize_mode" \
