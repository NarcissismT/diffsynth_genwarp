CUDA_VISIBLE_DEVICES=1,2,7,8,9 accelerate launch examples/flux/model_training/train.py \
  --dataset_base_path /juicefs-algorithm/data/IPT/junle_liu/滤镜/train/data/highlight_hecheng/ \
  --dataset_metadata_path /juicefs-algorithm/data/IPT/junle_liu/滤镜/train/data/highlight_hecheng/metadata_highlight_hecheng_kontext.csv \
  ...
  --output_path "./models/train/FLUX.1-Kontext-dev_lora-qufanguanghecheng-new" \
  --lora_base_model "dit" \
