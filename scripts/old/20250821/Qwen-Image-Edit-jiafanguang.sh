CUDA_VISIBLE_DEVICES=1,2,7,8,9 accelerate launch examples/qwen_image/model_training/train.py \
  --dataset_base_path /juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/data/highlight/ \
  --dataset_metadata_path /juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/data/highlight/metadata_edit.csv \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/models/train/Qwen-Image-Edit_lora/20250821/highlight-new" \
  --lora_base_model "dit" \
