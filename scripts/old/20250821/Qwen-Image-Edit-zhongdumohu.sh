CUDA_VISIBLE_DEVICES=1,2,7,8,9 accelerate launch examples/qwen_image/model_training/train.py \
  --dataset_base_path data/zhongdu_mohu \
  --dataset_metadata_path data/zhongdu_mohu/metadata_mohu.csv \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/models/train/Qwen-Image-Edit_lora/20250821/zhongdu_mohutuihua" \
  --lora_base_model "dit" \
