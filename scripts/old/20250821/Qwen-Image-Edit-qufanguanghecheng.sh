CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch examples/qwen_image/model_training/train.py \
  --dataset_base_path /juicefs-algorithm/data/IPT/junle_liu/滤镜/train/data/highlight_hecheng/ \
  --dataset_metadata_path /juicefs-algorithm/data/IPT/junle_liu/滤镜/train/data/highlight_hecheng/metadata_highlight_hecheng_correct.csv \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/result/lora/qwen-image-edit/20250821/highlighthecheng2w-new" \
  --lora_base_model "dit" \
