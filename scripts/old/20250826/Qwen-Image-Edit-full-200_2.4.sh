CUDA_VISIBLE_DEVICES=1,2,7,9 accelerate launch --config_file examples/qwen_image/model_training/full/accelerate_config_zero2offload_4.yaml examples/qwen_image/model_training/train.py \
  --dataset_base_path /juicefs-algorithm/data/IPT/junle_liu/滤镜/train/data/deblur/ \
  --dataset_metadata_path /juicefs-algorithm/data/IPT/junle_liu/滤镜/train/data/deblur/metadata_mohu.csv \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/models/train/qwen-image-edit/20250826/full/deblur" \
