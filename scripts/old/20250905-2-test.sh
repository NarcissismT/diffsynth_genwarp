...
ckpt="/juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/20250905-1/step-10000.safetensors"
...
CUDA_VISIBLE_DEVICES=7 python /juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/qwen_image_batch_full_lora.py \
  --lora_path $ckpt \
