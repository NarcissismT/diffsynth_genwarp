CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch examples/qwen_image/model_training/train_re.py \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/result/lora/qwen-image-edit/20280828/lora/RealPDF" \
  --lora_base_model "dit" \
