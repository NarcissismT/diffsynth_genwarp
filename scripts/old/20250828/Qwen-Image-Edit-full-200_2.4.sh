CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch --config_file examples/qwen_image/model_training/full/accelerate_config_zero2offload_8.yaml examples/qwen_image/model_training/train.py \
  --dataset_base_path /juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/data/train/RealPDF/ \
  --dataset_metadata_path /juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/data/train/RealPDF/metadata_RealPDF.csv \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/result/full/qwen-image-edit/20280828/full/RealPDF" \
