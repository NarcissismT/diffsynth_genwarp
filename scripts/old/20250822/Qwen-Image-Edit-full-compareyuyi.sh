CUDA_VISIBLE_DEVICES=0,1,4,5,6,7,8,9 accelerate launch --config_file examples/qwen_image/model_training/full/accelerate_config_zero2offload_8.yaml examples/qwen_image/model_training/train.py \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/models/train/qwen-image-edit/20250822/full/dehighlight_compareyuyi" \
