CUDA_VISIBLE_DEVICES=1,2,4,5,7,8,9 accelerate launch examples/qwen_image/model_training/train.py \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/models/train/qwen-image-edit/20250822/lora/dehighlight_compareyuyi_lora" \
  --lora_base_model "dit" \
