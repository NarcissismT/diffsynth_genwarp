...
ckpt="/juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/result/20250915-1_1in10_unwarp/step-196000.safetensors"
...
for ((i=0; i<8; i++)); do
  ...
  output_dir="$ckpt.visualization/0917-2_realall-sp8_0915-1-196000_1024_$resize_mode/split_$i"
