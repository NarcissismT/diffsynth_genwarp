...
train_id=20260513-1_1in10_w_flow_head_v3_daflow

# Stage 2：冻结 DiT，只训练 FlowHead V3（DPT Head + CNN + GRU）
# 使用已训练好的 LoRA checkpoint 作为 DiT 初始权重
LORA_CKPT="/juicefs-algorithm/data/IPT/zhuochu_yang/DiffSynth-Studio/flow_head_ckpts/20260512-1_1in10_w_flow_head_v2/step-92000.safetensors"

accelerate launch train_flow_head_v3_daflow.py \
  ...
  --output_path "/juicefs-algorithm/data/IPT/zhuochu_yang/DiffSynth-Studio/flow_head_v3_daflow_ckpts/$train_id" \
  --lora_base_model "dit" \
