...
ckpt="/juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/result/20250929-1_1in10_w_unwarp/step-668000.safetensors"
# test_set="SDXL0829_测试集效果不佳"
test_set="/juicefs-algorithm/data/IPT/yuang_feng/DATA/warp_test/bad2"
# test_set="train/quark/img"

resize_mode="stretch"  # 设置 resize的方式
...
# 运行 Python 脚本，传递 --crop 参数
 python /juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/qwen_image_batch_full_lora.py \
  --lora_path $ckpt \
  --input_dir "$test_set" \
  --output_dir "$ckpt.visualization/1020-1_bad2_1024_$resize_mode" \
