...
ckpt="/juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/result/20250924-1_1in10_z_unwarp/step-148000.safetensors"
...
# 运行 Python 脚本，传递 --crop 参数
 python /juicefs-algorithm/data/IPT/yuang_feng/DiffSynth-Studio/qwen_image_batch_full_lora.py \
  --lora_path $ckpt \
  --input_dir "$test_set" \
  --output_dir "$ckpt.visualization/0930-3_bad2_1024_$resize_mode" \
