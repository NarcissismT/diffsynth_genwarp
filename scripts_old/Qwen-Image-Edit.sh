CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch examples/qwen_image/model_training/train.py \
  ...
  --dataset_metadata_path data/highlight/metadata_edit.csv \
  ...
  --output_path "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/result/lora/qwen-image-edit/highlight" \
  --lora_base_model "dit" \
