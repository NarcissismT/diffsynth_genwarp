CUDA_VISIBLE_DEVICES=1,7,8,9 accelerate launch examples/flux/model_training/train.py \
  --dataset_base_path /juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/data/highlight/ \
  --dataset_metadata_path /juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/data/highlight/metadata_edit_kontext.csv \
