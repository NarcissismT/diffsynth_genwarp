...
def process_images(input_dir, output_dir, prompt, batch_size=1):
    ...
    # 加载LoRA模型
    pipe.load_lora(pipe.dit, "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/models/train/Qwen-Image-Edit_lora/20250821/zhongdu_mohutuihua/step-100.safetensors")
...
if __name__ == "__main__":
    # 配置参数
    input_directory = "/juicefs-algorithm/data/IPT/yihan_xu/Go_Pro分类/中度模糊/target"
    output_directory = "/juicefs-algorithm/data/IPT/haonan_wu/Code/DiffSynth-Studio/results/zhongdumohu_tuihua_step100"
    
    # 定义prompt
    prompt_text = "对这张清晰图像应用中等程度的模糊效果，模拟图像退化过程。"
